...
import com.codepath.apps.tumblrsnap.fragments.PullToRefreshListViewFragment;
...
import com.codepath.apps.tumblrsnap.fragments.StaggeredGridViewFragment;
...
public class MainActivity extends FragmentActivity implements OnLoginHandler {
	...
	public void onPostButton(MenuItem menuItem) {
	...
	private void showRefrashFragment() {
		showFragment(PullToRefreshListViewFragment.class);
	}

	private void showStaggeredGridViewFragment() {
		showFragment(StaggeredGridViewFragment.class);
	}

	@SuppressWarnings("rawtypes")
	private void showFragment(Class activeFragmentClass) {
		Class[] fragmentClasses = new Class[] { LoginFragment.class,
				PhotosFragment.class, PullToRefreshListViewFragment.class,
				StaggeredGridViewFragment.class };
